...
export default function Signin() {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      ...
      setIsError(true);
      setMessage(err.response?.data?.message || err.response?.data?.error || "Failed to send reset instructions. Please try again.");
      console.error(err.response?.data || err.message);
    } finally {
      ...
      <div className="max-w-md w-full">
        ...
        {showForgotPassword ? (
          <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
            <form className="p-8 space-y-6" onSubmit={handleForgotPassword}>
              ...
              <div className="flex space-x-4">
                <button
                  ...
                  className="flex-1 py-3 px-4 border border-gray-300 text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-all duration-200"
                >
                  Back to Login
                </button>
                <button
                  ...
                  className={`flex-1 flex justify-center items-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white transition-all duration-200 ${
                    isForgotPasswordLoading 
                      ? 'bg-gray-400 cursor-not-allowed' 
                      : 'bg-gradient-to-r from-red-600 to-black hover:from-red-700 hover:to-gray-900 hover:shadow-lg'
                  }`}
                >
                  {isForgotPasswordLoading ? (
                    <>
